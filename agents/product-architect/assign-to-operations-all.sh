#!/bin/bash
# Script pentru Product-Architect să assign-eze task-uri către Operations-All
# Usage: assign-to-operations-all <task-id> <title> <description> <priority>

TASK_ID=$1
TITLE=$2
DESCRIPTION=$3
PRIORITY=${4:-medium}
AGENT="operations-all"
PORT=18797
...
echo "🚀 Trigger trimis către Operations-All via port $PORT"